...
#Kranen
gripper_motor = Motor(Port.A, Direction.COUNTERCLOCKWISE, [12, 36])
...
class Crane:
    ...
    def robot_pick(self, position):
        ...
        #Lukker kroken
        gripper_motor.run_until_stalled(500, then=Stop.HOLD, duty_limit=40)
        # Løfter armen opp til startposisjonen helt til refleksjonssensoren merker en refleksjon mindre enn 32
        elbow_motor.run(60)
    ...
    def robot_release(self, position):
        ...
        gripper_motor.run_target(-500, -200)
        # Raise the arm.
        elbow_motor.run(60)
        while elbow_sensor.reflection() < 32:
            wait(10)
...
def start():
        ...
        base_motor.hold()
        #Tester kroken
        gripper_motor.run_until_stalled(500, then=Stop.COAST, duty_limit=40)
